...
public class WareLiveBean {
	...
	public Integer getQuitSupplement() {
		return quitSupplement;
	}

	public void setQuitSupplement(Integer quitSupplement) {
	...
	public Integer getInsertSupplement() {
		return insertSupplement;
	}

	public void setInsertSupplement(Integer insertSupplement) {
